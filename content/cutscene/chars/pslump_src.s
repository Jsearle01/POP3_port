...
*
* ORIGIN: IMG.CHTAB6.A
*         POP cel: #10 (3x43 bytes)
* Colour model: adjacency + screen-col parity + colour-cell fill.
*   Carried VERBATIM from karateka_coco3 sprite_convert.py (MAME-verified
*   TASK 1/2 gate 2026-05-16; colour-cell fill P4 gate 2026-06-13).
*   0=Black 1=Orange(odd screen col) 2=Blue(even screen col) 3=White
*   start_col=124  screen-col parity=EVEN
* [ref: HIRES.S:180-186 cel format; GRAFIX.S:341 ADDMID; TABLES.S:51-67]

pslump_src:
        fcb     43,6  ; height=43 rows, coco3_width=6 bytes/row (4px/byte)
        fcb     $00,$00,$03,$EF,$C0,$00  ; row 0
        fcb     $00,$00,$01,$00,$10,$00  ; row 1
        fcb     $00,$00,$0F,$00,$0F,$00  ; row 2
        fcb     $00,$00,$08,$00,$00,$00  ; row 3
        fcb     $00,$00,$10,$01,$00,$00  ; row 4
        fcb     $00,$00,$10,$01,$50,$00  ; row 5
        fcb     $00,$00,$F0,$01,$00,$00  ; row 6
        fcb     $00,$00,$80,$01,$00,$00  ; row 7
        fcb     $00,$00,$80,$00,$00,$00  ; row 8
